...
<%@ include file="/WEB-INF/jsp/commonHeader.jspFrag" %>
	...
	<ul>
		...
		<li><a href="/paul/facilitySelect?next=facilityLogin">Start an Instrument Session</a> - when login isn't working on the instrument</li>
		<li><a href="/paul/facilitySelect?next=claimDatasets">Claim My Data</a> - for files that you saved when you weren't logged in</li>
